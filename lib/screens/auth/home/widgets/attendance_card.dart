...
import 'package:attandance_app/screens/auth/home/widgets/photo_viewer.dart';
...
class AttendanceCard extends StatelessWidget {
  ...
  (Color, Color, IconData, String) _getCardStyle(bool hasCheckedIn, bool hasCheckedOut) {
    if (!hasCheckedIn) {
      ...
      return (Colors.green[50]!, Colors.green[600]!, Icons.check_circle_outline_rounded, 'work complete');
    } else {
      return (Colors.blue[50]!, Colors.blue[600]!, Icons.wordpress_rounded, 'Currently Working');
    }
  }
